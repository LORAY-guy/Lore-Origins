...
function onCreate()
    makeLuaSprite("pizzaIconP1", 'newOurpleHUD/pizza', 839, 540)
    ...
    makeLuaSprite("pizzaIconP2", 'newOurpleHUD/pizza', 236, 540)
    ...
    for i = 1, 5 do
        makeAnimatedLuaSprite('star'..i, 'star', startStar, 600)
...
function onCreatePost()
    ...
    setProperty("scoreTxt.y", 55)
    setTextFont('scoreTxt', 'DIGILF__.TTF')
    setProperty('healthBar.y', 610)
