...
class DiscordClient
{
	...
	private static final _defaultID:String = "1167949518822715472";
	...
	public static function changePresence(?details:String = 'LOOOOOOOORE', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Lore Version: " + states.MainMenuState.loreVersion;
