...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['UpdateHUD', "updates the hud, idk"],
		['setNotePosition', "sets note positions, idk"]
	];
	...
	**/
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.voices(currentSongName, PlayState.isNew);
		vocals = new FlxSound();
	...
	function generateSong() {
		FlxG.sound.playMusic(Paths.inst(currentSongName, PlayState.isNew), 0.6/*, false*/);
